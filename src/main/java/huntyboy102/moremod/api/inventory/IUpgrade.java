...
/**
 * Created by Simeon on 4/11/2015. This is used by Machines to increase stats.
 */
public interface IUpgrade {
	...
	/**
	 * Return the main Upgrade type for the given Upgrade. This is to check if an
	 * upgrade can even go in the upgrade slot.
	 *
