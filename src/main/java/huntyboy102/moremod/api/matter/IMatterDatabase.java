...
public interface IMatterDatabase {
	 ...
	 * @param initialAmount the amount of initial progress the patterns has. It
	 *                      ranges from 0 - 100%
	 * @param simulate      is this call a simulation. Does no actual storing of
	 *                      item. Used to check if the database can handle or store
	 *                      a given Item Stack without actually storing it.
	 * @param info          the string builder used to store information on the
	 *                      storing process of the item stack's pattern. It gives
	 *                      useful information about why the pattern didn't get
	 ...
	 * @return The pattern of the given Item Stack, {@code null} if the stack wasn't
	 *         found.
	 */
	 ...
	 *
	 * @param item The item stack to search for.
	 * @return The pattern instance of the given pattern, {@code null} if the
