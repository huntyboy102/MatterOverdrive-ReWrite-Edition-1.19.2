...
import huntyboy102.moremod.client.model.baked.BakedModelBase;
...
public class ModelBlock extends ModelBase {
	...
	public ModelBlock(Class<? extends BakedModelBase> block, ResourceLocation particle, ResourceLocation top,
			ResourceLocation side, ResourceLocation bottom) {
		this(block, particle, side, side, side, side, top, bottom);
	}

	public ModelBlock(Class<? extends BakedModelBase> block, ResourceLocation particle, ResourceLocation north,
			ResourceLocation east, ResourceLocation south, ResourceLocation west, ResourceLocation up,
			ResourceLocation down) {
		try {
			this.constructor = block.getConstructor(IModelState.class, VertexFormat.class, Function.class,
					ModelBase.class);
