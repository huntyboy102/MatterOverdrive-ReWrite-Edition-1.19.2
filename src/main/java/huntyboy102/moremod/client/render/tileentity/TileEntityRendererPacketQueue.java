...
import huntyboy102.moremod.blocks.BlockNetworkSwitch;
...
public class TileEntityRendererPacketQueue extends TileEntitySpecialRenderer<TileEntityMachinePacketQueue> {
	...
	@Override
	public void render(TileEntityMachinePacketQueue tileEntity, double x, double y, double z, float partialTicks,
