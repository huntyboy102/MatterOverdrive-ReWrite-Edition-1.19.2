...
//        }
		...
		int countWitdth = Minecraft.getMinecraft().fontRenderer
				.getStringWidth(MOStringHelper.formatNumber(patternCount, "0"));
		...
		Minecraft.getMinecraft().fontRenderer.drawString(MOStringHelper.formatNumber(patternCount, "0"), 0, 0,
				0x78a1b3);
