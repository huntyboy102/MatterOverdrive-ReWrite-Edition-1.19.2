...
public class DialogMessageQuestOnObjectivesCompleted extends DialogMessage {
	...
	public DialogMessageQuestOnObjectivesCompleted(String message, String question, QuestStack questStack,
			int[] completedObjectives) {
	...
	public DialogMessageQuestOnObjectivesCompleted(String[] messages, String[] questions, QuestStack questStack,
			int[] completedObjectives) {
