...
import huntyboy102.moremod.client.render.weapons.WeaponItemRenderer;
...
public class GuiWeaponStation extends MOGuiMachine<TileEntityWeaponStation> {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		if (WeaponHelper.isWeapon(item) && pages.get(0).isVisible()) {
			...
			GlStateManager.pushMatrix();
			GL11.glLineWidth(1f);
			GlStateManager.color(Reference.COLOR_MATTER.getFloatR(), Reference.COLOR_MATTER.getFloatG(),
