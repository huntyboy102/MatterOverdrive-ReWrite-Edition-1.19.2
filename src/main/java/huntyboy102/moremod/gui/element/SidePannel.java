...
public class SidePannel extends ElementBaseGroup {
	...
	public final ScaleTexture BACKGROUND_TEXTURE = new ScaleTexture(
			new ResourceLocation(Reference.PATH_ELEMENTS + "right_side_bar_panel_bg.png"), 15, 18)
			.setOffsets(7, 7, 8, 9);
	...
	public SidePannel(MOGuiBase gui, int posX, int posY, int height, boolean openable) {
		...
		button.setNormalTexture(
				new ScaleTexture(new ResourceLocation(Reference.PATH_ELEMENTS + "right_side_bar_over.png"), 32, 143)
						.setOffsets(0, 0, 42, 100));
