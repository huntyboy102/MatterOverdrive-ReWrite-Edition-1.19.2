...
package huntyboy102.moremod.handler.village;

import huntyboy102.moremod.world.MadScientistHouse;
...
public class VillageCreatationMadScientist implements VillagerRegistry.IVillageCreationHandler {
	...
	public StructureVillagePieces.Village buildComponent(StructureVillagePieces.PieceWeight villagePiece,
			StructureVillagePieces.Start startPiece, List<StructureComponent> pieces, Random random, int p1, int p2,
