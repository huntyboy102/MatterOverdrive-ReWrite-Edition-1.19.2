...
public class MatterOverdriveEntities {
	...
	public static void registerProfessions(final RegistryEvent.Register<VillagerProfession> event) {
		...
		MAD_SCIENTIST_PROFESSION = new VillagerProfession(Reference.MOD_ID + ":mad_scientist",
				Reference.PATH_ENTITIES + "mad_scientist.png", Reference.PATH_ENTITIES + "hulking_scinetist.png");
		{
			...
			new VillagerCareer(MAD_SCIENTIST_PROFESSION, Reference.MOD_ID + ".mad_scientist.name")
					...
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(MatterOverdrive.ITEMS.androidPill,
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.androidPill, 1, 1),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.androidPill, 2, 2),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(MatterOverdrive.ITEMS.h_compensator,
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(MatterOverdrive.ITEMS.dilithium_crystal,
									new EntityVillager.PriceInfo(-7, -5)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(MatterOverdrive.ITEMS.weapon_module_barrel,
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.weapon_module_barrel, 1, 1),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
					...
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.weapon_module_barrel, 1, 3),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.weapon_module_barrel, 1, 4),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1,
							new EntityVillager.ListItemForEmeralds(
									new ItemStack(MatterOverdrive.ITEMS.weapon_module_barrel, 1, 5),
									new EntityVillager.PriceInfo(20, 30)))
					.addTrade(1, new EntityVillager.ListItemForEmeralds(MatterOverdrive.ITEMS.earl_gray_tea,
							new EntityVillager.PriceInfo(-8, 30)));
		}
	}

	public static boolean addEntity(Class<? extends Entity> enityClass, String name, int mainColor, int spotsColor,
			int id) {
		boolean enabled = MatterOverdrive.CONFIG_HANDLER.config.getBoolean("enable",
				String.format("%s.%s", ConfigurationHandler.CATEGORY_ENTITIES, name), true, "");
		if (enabled)
			EntityRegistry.registerModEntity(new ResourceLocation(Reference.MOD_ID + ":" + name), enityClass, name, id,
					MatterOverdrive.INSTANCE, 64, 1, true, mainColor, spotsColor);
		return enabled;
	}
}