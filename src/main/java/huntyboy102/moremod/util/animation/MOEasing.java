...
public class MOEasing {
	...
	public static class Elastic {
		...
		public static float easeIn(float t, float b, float c, float d) {
			...
			float p = d * .3f;
			float s = p / 4;
			return -(c * (float) Math.pow(2, 10 * (t -= 1)) * (float) Math.sin((t * d - s) * (2 * (float) Math.PI) / p))
					+ b;
		}
		...
		public static float easeOut(float t, float b, float c, float d) {
			...
			float p = d * .3f;
			float s = p / 4;
			return (c * (float) Math.pow(2, -10 * t) * (float) Math.sin((t * d - s) * (2 * (float) Math.PI) / p) + c
					+ b);
		}
		...
		public static float easeOut(float t, float b, float c, float d, float a, float p) {
			...
			return (a * (float) Math.pow(2, -10 * t) * (float) Math.sin((t * d - s) * (2 * (float) Math.PI) / p) + c
					+ b);
		}
		...
		public static float easeInOut(float t, float b, float c, float d) {
			...
			float s = p / 4;
			if (t < 1) {
				return -.5f * (c * (float) Math.pow(2, 10 * (t -= 1))
